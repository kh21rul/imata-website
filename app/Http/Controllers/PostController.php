...
class PostController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->meta->url = env('APP_URL') . '/blog';
        $this->meta->type = 'blog';
    ...
    public function index()
    {
        ...
        if (request('category')) {
            ...
            $this->meta->url = env('APP_URL') . '/blog?category=' . $category->slug;
        }
        ...
        if (request('tag')) {
            ...
            $this->meta->url = env('APP_URL') . '/blog?tag=' . $tag->slug;
        }
        ...
        if (request('author')) {
            ...
            $this->meta->url = env('APP_URL') . '/blog?author=' . $author->username;
        }
    ...
    public function show(Post $post)
    {
        ...
        $this->meta->url = env('APP_URL') . '/blog/' . $post->slug;
        $this->meta->type = 'article';
        $this->meta->image = env('APP_URL') . '/storage/' . $post->image;
