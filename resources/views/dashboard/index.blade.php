                ...
                <div class="row">
                    <div class="col-12 mb-4">
                        <div class="hero text-white hero-bg-image hero-bg-parallax"
                            data-background="{{ asset('dbuser/assets/img/bg.jpg') }}"
                            style="background-image: url(&quot;dbuser/assets/img/unsplash/andre-benz-1214056-unsplash.jpg&quot;);">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card card-warning">
                                    <div class="card-header">
                                        <h4 class="text-warning">Postingan Terbaru</h4>
                                    </div>
                                            ...
                                            <table class="table table-striped">
                                                <tbody>
                                                    ...
                                                    @foreach ($posts as $post)
                                                        <tr>
                                                            <td>{{ $start++ }}</td>
                                                            <td class="font-weight-600" width="50%">{{ $post->title }}
                                                            </td>
              ...
              <ul class="list-unstyled list-unstyled-border">
                <li class="media">
                  ...
                  <div class="media-body">
                    <div class="float-right text-warning">Now</div>
