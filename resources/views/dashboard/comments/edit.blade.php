                        ...
                        <div class="card card-warning">
                            ...
                            <div class="card-body">
                                <form action="/dashboard/comments/{{ $comment->id }}" method="post">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label for="email"
                                            class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Komentar</label>
                                        <div class="col-sm-12 col-md-7">
                                            <textarea name="body" style="height: 100px; overflow: auto;" id="body"
                                                class="form-control @error('body') is-invalid @enderror" required>{{ old('body', $comment->body) }}</textarea>
                                            @error('body')
                                                <span class="invalid-feedback" role="alert">
                                                    {{ $message }}
                                                </span>
