...
<head>
    ...
    <title>{{ $title ?? '' }} - IMATA Dashboard</title>
    ...
    <link rel="stylesheet"
        href="{{ asset('dbuser/node_modules/datatables.net-bs4/css/dataTables.bootstrap4.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('dbuser/node_modules/datatables.net-select-bs4/css/select.bootstrap4.min.css') }}">
