<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand text-left pl-4 pt-4 mb-3">
            <a href="/dashboard">
                <h5><img src="{{ url('dbuser/assets/img/logo.png') }}" width="30" alt="logo"> IMATA</h5>
            </a>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ Request::is('dashboard/products*') ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('dashboard/products/create') ? 'active' : '' }}"><a class="nav-link"
        ...
        <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
            <a href="/" target="_blank" class="btn btn-warning btn-lg btn-block btn-icon-split">
