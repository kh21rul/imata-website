                ...
                <div class="search col-lg-10 my-4 pb-4">
                    <form action="/blog">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control form-control-lg" placeholder="Mau Cari Apa ? "
                                ...
                                <div class="entry-meta">
                                    <ul>
                                        ...
                                        <li class="d-flex align-items-center"><i
                                                class="bi bi-clock"></i>{{ $posts[0]->created_at->format('H:i') }}</li>
                                        <li class="d-flex align-items-center"><i
                                                class="bi bi-calendar-check"></i>{{ $posts[0]->created_at->format('d M Y') }}
                                        </li>
                            ...
                            <article class="entry">
                                ...
                                <div class="entry-meta">
                                    <ul>
                                        ...
                                        <li class="d-flex align-items-center"><i
                                                class="bi bi-calendar-check"></i>{{ $post->created_at->format('d M Y') }}
                                        </li>
                                        <li class="d-flex align-items-center"><i class="bi bi-bookmarks"></i> <a
