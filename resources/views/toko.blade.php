...
@section('container')
            ...
            <div id="test-list">
                <div class="row justify-content-end">
                    <div class="col-lg-4 form-floating mb-4">
                        <input type="text" class="form-control fuzzy-search ps-4" id="floatingInput"
                        ...
                        @isset($products)
                            @foreach ($products as $product)
                                <div class="col-lg-3 col-md-6 toko-item filter-app mb-5">
                                    <div class="toko-wrap">
                                        @if ($product->image)
                                            <img src="{{ asset('storage/' . $product->image) }}" class="img-fluid"
                                                alt="{{ $product->name }}" width="290" height="372">
                                        @else
                                            <img src="{{ asset('img/product-contoh.jpg') }}" class="img-fluid"
                                                alt="{{ $product->name }}" width="290" height="372">
                                        @endif
                                        <div class="toko-info">
                                            <div>
                                    ...
                                    <h4><a href="#" data-bs-toggle="modal" data-bs-target="#beli"
                                            class="name">{{ $product->name }}</a></h4>
    ...
    <!---------------Modal----------------------->
    <div class="detail-produk modal fade" id="beli" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body p-2">
                    <div class="row">
                        ...
                        <div class="col-lg-7 py-5 px-3">
                            ...
                            <h5>Rp 200.000</h5>
                            <p>Deskripsi : <br>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam cupiditate natus distinctio
                                perferendis consectetur mollitia quas inventore repellat culpa aliquam exercitationem
                                reprehenderit amet alias, voluptate ullam sint nam placeat. Inventore!
                            </p>
                            <div class="d-grid gap-2 mt-5">
                                <a href="" target="_blank" class="btn btn-outline-success me-lg-3"><i
